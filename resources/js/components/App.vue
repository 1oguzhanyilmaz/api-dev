    ...
    <div class="h-screen bg-white">
        ...
        <div class="flex">
            ...
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    <router-link to="/">
                        <span class="text-blue-600 w-12 h-12">Logo</span>
                    </router-link>
                    ...
                    <router-link to="/contacts/create" class="flex items-center py-2 text-sm">
                        ...
                        <div class="tracking-wide pl-3 hover:text-blue-600">Add New</div>
                    </router-link>
                    ...
                    <router-link to="/contacts" class="flex items-center py-2 text-sm">
                        ...
                        <div class="tracking-wide pl-3 hover:text-blue-600">Contacts</div>
                    </router-link>
                    <router-link to="/birthdays" class="flex items-center py-2 text-sm">
                        ...
                        <div class="tracking-wide pl-3 hover:text-blue-600">Birthdays</div>
                    </router-link>

                    <p class="pt-12 text-xs text-gray-500 uppercase font-bold">Settings</p>
                    <router-link to="/logout" class="flex items-center py-2 text-sm">
                        ...
                        <div class="tracking-wide pl-3 hover:text-blue-600">Logout</div>
                    </router-link>
                </nav>
            </div>
