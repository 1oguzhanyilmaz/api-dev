    ...
    <div class="">
        ...
        <div class="relative z-10">
            <div class="absolute h-full flex items-center justify-center">
                <svg viewBox="0 0 24 24" class="h-full w-5 mt-2 ml-2">
            ...
            <input class="w-64 mr-6 bg-gray-200 border border-gray-400 pl-8 pr-3 py-1 rounded-full text-sm focus:outline-none focus:border-blue-500 focus:shadow focus:bg-gray-100" type="text" placeholder="Search..." id="searchTerm" v-model="searchTerm" @input="search" @focus="focus=true">

            <div v-if="focus" class="absolute bg-gray-200 text-black rounded-lg p-4 w-96 right-0 mr-6 mt-2 shadow z-20">
